...
namespace NS_Composants
{
	...
	public:
		CAD() {
			this->rq_sql = "RIEN";
			this->cnx = "Data Source=(local);Initial Catalog=GROUPE10BDD;Integrated Security=True";
		...
		void readClient(System::Windows::Forms::TextBox^ textBox1, System::Windows::Forms::TextBox^ textBox2, System::Windows::Forms::TextBox^ textBox3, System::Windows::Forms::TextBox^ textBox4, System::Windows::Forms::TextBox^ textBox5, System::Windows::Forms::TextBox^ textBox6, System::Windows::Forms::TextBox^ textBox7) {
			while (this->READ->Read()) {
				...
				textBox5->Text = System::Convert::ToString(READ->GetDateTime(6));
				textBox6->Text = READ->GetString(4);
				textBox7->Text = READ->GetString(5);
			}
			this->READ->Close();
		}
		void readPersonnel(System::Windows::Forms::TextBox^ textBox7, System::Windows::Forms::TextBox^ textBox1, System::Windows::Forms::TextBox^ textBox2, System::Windows::Forms::TextBox^ textBox4, System::Windows::Forms::TextBox^ textBox3) {
			while (this->READ->Read()) {
