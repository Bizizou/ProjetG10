...
namespace NS_SVC {
	...
	public:
		...
		void afficherByID(int ID, System::Windows::Forms::TextBox^ textBox7, System::Windows::Forms::TextBox^ textBox1, System::Windows::Forms::TextBox^ textBox2, System::Windows::Forms::TextBox^ textBox4, System::Windows::Forms::TextBox^ textBox3, System::Windows::Forms::BindingSource^ bindingsource2, System::Windows::Forms::DataGridView^ datagridview2) {
			Personnel->setID(ID);
			cad->requete(Personnel->AFFICHERbyID());
			cad->readPersonnel(textBox7, textBox1, textBox2, textBox4, textBox3);
		...
		void modifier(int ID, System::String^ Nom, System::String^ Prenom, System::String^ adresse, System::String^ dateembauche, System::String^ nom_encadreur, System::String^ prenom_encadreur) {
			Personnel->setID(ID);
			Personnel->setNom(Nom);
			Personnel->setPrenom(Prenom);
			Personnel->setadresse(adresse);
